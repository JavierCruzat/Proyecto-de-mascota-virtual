...
boton_alimento_rect=boton_alimento_imag.get_rect(topleft=(850,150))

boton_felicidad_imag=pygame.image.load("Proyecto/imagenes/mogus.jpg")
boton_felicidad_rect=boton_felicidad_imag.get_rect(topright=(10,180))
